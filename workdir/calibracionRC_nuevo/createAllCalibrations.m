%% CRear todas las calibraciones y guardarlos con sus respectivos intervalos de incertidumbre
...
for filmIndex=1:3
    ...
    DR2 = confint(fR2r,0.683);
    dCoefR2 = 0.5*(DR2(2,:) - DR2(1,:));   
    DG2 = confint(fG2r,0.683);
    dCoefG2 = 0.5*(DG2(2,:) - DG2(1,:));
    DB2 = confint(fB2r,0.683);
    dCoefB2 = 0.5*(DB2(2,:) - DB2(1,:));    
