...
fullPath = [basePath filesep 'EBT2' filesep '10MeV'];
radName = 'Rad18';
...
logName = 'irrLog_2020_07_08_18_21_36.log';
...
load('/Users/dani/Documents/FIESTA/workdir/calibracionRC_nuevo/fitCoef_FQS_EBT2.mat')
...
finalSigmasY = sigmaY_mm(11+theMask); %% Porque fallaba en este
...
%coatingThickness_cm = 80*1e-4; % Si es que ha sido Lado 1
coatingThickness_cm = 175*1e-4; % Si es que ha sido Lado 1
