...
fullPath = [basePath filesep 'EBT3' filesep '4MeV'];
radName = 'Rad4b';
...
theMask=1:3
finalSigmasX(1) = 0.5*(sigmaX_mm(1) + sigmaX_mm(12));
finalSigmasX(2) = 0.5*(sigmaX_mm(2) + sigmaX_mm(13));
finalSigmasX(3) = (1/3)*(sigmaX_mm(3) + sigmaX_mm(5) + sigmaX_mm(14));
finalSigmasY(1) = 0.5*(sigmaY_mm(1) + sigmaY_mm(12));
finalSigmasY(2) = 0.5*(sigmaY_mm(2) + sigmaY_mm(13));
finalSigmasY(3) = (1/3)*(sigmaY_mm(3) + sigmaY_mm(5) + sigmaY_mm(14));
