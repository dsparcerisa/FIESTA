...
fullPath = [basePath filesep 'EBT2' filesep '4MeV'];
radName = 'Rad5';
...
logName = 'irrLog_2020_07_08_15_42_23.log';
...
% Resto
Xpositions_cm = 3 - [3 2 3 2 3 2 1 0 1 0 1]';
Ypositions_cm = 2.5 - [2.5 1.5 0.5 -0.5 -1.5 -2.5 2.5 1.5 0.5 -0.5 -1.5]' ;
...
load('/Users/dani/Documents/FIESTA/workdir/calibracionRC_nuevo/fitCoef_HF_EBT2.mat')
...
I_final = 42;
Ierror = 4; 
I_values = linspace(I_inicial, I_final, 11+5);
