...
filePaths = {fullfile(Fcfg.filmPath,'cal0008.tif'),fullfile(Fcfg.filmPath,'cal0007.tif')};
nCrops = [4 2];
...
save('contours_feb4.mat');

%% Buscar centros y sigmas --> Realinear y recropear automáticamente para que ambas sean idénticas

clear all
load('contours_feb4.mat');fac = 3; % how many times HD is supposed to be larger than LD
HL_multiplier = 0.9:0.01:1.1;
